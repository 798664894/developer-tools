 ...
 * @Date: 2021-06-11
 -->
<template>
  <div class="cardNoBuilder">
    <div class="mother-land row">
      <span class="title">出生地</span>
      <el-select
        v-model="provience"
        placeholder="请选择"
        class="box"
        @change="clickProvience"
      >
        <el-option
          v-for="(name, number) in provinceJson"
          :key="number"
          :label="name"
          :value="number"
        >
      ...
      <el-select v-model="country" placeholder="请选择" class="box">
        <el-option
          v-for="(name, number) in countyObj"
          :key="number"
          :label="name"
          :value="number"
        >
    ...
    <div class="cardNo flex">
      <div class="left-list carNo-list">
        <div v-for="cardNo in leftCardNoList" :key="cardNo">
          {{ cardNo }}
        </div>
      </div>
      <div class="right-list carNo-list">
        <div v-for="cardNo in rightCardNoList" :key="cardNo">
          {{ cardNo }}
        </div>
      </div>
      <el-button
...
export default class cardNoBuilder extends Vue {
  ...
  private provience: string = '11'
  private city: string = '1101'
  private country: string = '110101'
  private provinceJson: object = {
    '11': '北京市',
    '12': '天津市',
    '13': '河北省',
    '14': '山西省',
  ...
  private clickProvience(): void {
    for (let cityObjKey in this.cityObj) {
      this.city = cityObjKey
      break
    }
    this.clickCity()
  }

  private clickCity(): void {
    for (let cityObjKey in this.countyObj) {
      this.country = cityObjKey
      break
    }
  }

  private buildCardNo(): void {
    this.leftCardNoList = []
    this.rightCardNoList = []
    let cardNo: string = ''
    cardNo += this.country
